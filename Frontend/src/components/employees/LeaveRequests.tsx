...
import { Check, X, Calendar, Clock, ChevronDown, CalendarDays, Activity, Plus, Edit2 } from "lucide-react";
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          ...
          <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
            <DialogTrigger asChild>
              <button className="px-4 py-2 bg-primary hover:bg-primary text-primary-foreground rounded-xl text-sm font-bold shadow-sm flex items-center justify-center gap-2 transition-colors shrink-0">
          ...
          <DialogClose asChild>
            <button className="p-2 text-muted-foreground hover:text-foreground/80 hover:bg-muted rounded-full transition-colors">
              ...
              <form onSubmit={handleAddLeave} className="flex flex-col max-h-[80vh]">
                <div className="p-5 sm:p-6 md:p-8 space-y-5 overflow-y-auto max-h-[70vh]">
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1.5 block">Leave Dates</label>
                    <DateRangeFilter
                      value={{
                      ...
                      className="w-full h-[46px] justify-between"
                      align="start"
                    />
                  </div>
